...
function initializePlayer(client) {
    ...
    client.riffy.on("trackStart", async (player, track) => {
        ...
        .setDescription(`:music:  **Tên Bài Hát:** [${track.info.title}](${track.info.uri})\n:3177magicwandcom1:  **Nghệ Sĩ:** ${track.info.author}\n:media43:  **Nền Tảng :** :Youtube: , :Spotify: `)
        ...
        const showQueueButton = new ButtonBuilder()
            ...
            .setLabel("Hiện Danh Sách Chờ")
            .setStyle(ButtonStyle.Primary);
        const clearQueueButton = new ButtonBuilder()
            .setCustomId("clearQueue")
            .setLabel("Xóa Danh Sách Chờ")
